# Long-run growth trends {#LRG}

```{r quote, eval=FALSE, include=FALSE}

Include Lucas quote regarding growth facts?
+ Levi-Strauss quote?
...
- **The great divergence**: This exponential growth pattern started at different times for different countries and there is nothing to suggest that the countries lagging behind will eventually catch up to the most advanced economies. The difference between the richest and the poorest countries in this sample has grown from a factor of 4 to 5 in 1800 (UK GDP per capita was 5 times higher than in Indonesia) to a factor of 10 to 11 in 2018 (US GDP per capita was 11 times higher than in Nigeria).
- **A variety of experiences**: Looking at the plot more closely, the path has not been entirely smooth in most countries, with some countries such as the Russian Federation, Japan or South Africa experiencing decades of stagnation or decline in the last 50 years. Some of the poorest countries, not represented here, have seen little to no growth as well as periods of prolonged decline over the same period.

It should not be concluded from this first foray into long-run GDP growth trends that the processes underlying them are deterministic in the sense that they are produced by irrepressible forces largely beyond the control of human organisations or that they are normative in the sense that exponential growth represents the ultimate goal of human societies. Rather, the trends we observe reflect the outcomes of historical processes in different societies at different points in time. They are made possible by specific institutional, geographical, cultural characteristics and shaped by relationships of power within and between countries. 

### Growth rates and the power of compunding effects {-}

The dynamics of GDP levels over the long term observed in Figure \@ref(fig:mpdplot1) are the result of growth processes that are cumulative over time. Each year, the economy is able to build on the previous level of production to generate more output, which allows for further increases in output in the following year, etc... In this view, the **growth rate** of output from one year to the next is a useful indicator of the ability of an economy to generate more output over time, which can be used to compare the performance of economies of different sizes and at different points in time. Economic theories of growth seek to understand the mechanisms that drive these changes in output over time and the reason why growth rates may differ across countries. 
...
**1. Why have American on average much bigger fridges and bigger cars than the average Briton?**

Between 1885 and 2022, GDP per capita in the United Kingdom increased from \$6,132 to \$38,407 (2011 dollars). Standards of living have therefore been multiplied by more than 6 in this country over this period. In contrast, GDP per capita in the United States over the same period has increased from \$6,424 to \$58,487 (2011 dollars) so that standards of living have been multiplied by 9. Starting at a similar level as in the United Kingdom, GDP per capita in the United States has therefore grown at a faster rate and is now about 50% higher. How much higher must have been the annual growth rate of GDP per capita in the United States relative to the United Kingdom to arrive at this outcome?

**2. Why has GDP per capita in Nigeria not converge to that of the United Kingdom?**

GDP per capita in Nigeria has increased from \$810 to \$5,070 (2011 dollars) between 1885 and 2022. Therefore in both the United Kingdom and Nigeria, standards of living have been multiplied by slightly more than 6 over this period. As we will see, this means that they have grown at the same average annual growth rate over this period. As a result, the two countries have not diverged further over this period but they have not converged either; the United Kingdom was slightly more than 7.5 times richer than Nigeria in 1885 and it is still a bit more than 7.5 times richer than Nigeria in 2022. Two countries starting at different levels of GDP per capita but growing at the same annual growth rate will not converge. For GDP per capita in Nigeria to have converged to that of the United Kingdom over this period, how much higher should its annual growth rate have been on average?

The answer to both questions is probably less than you would expect due to the power of compounding effects. By the end of this chapter, you will be able to reformulate these problems in mathematical terms and solve for the precise answers. You will also be equipped to produce informative graphical representations of growth trajectories (using the power of logarithms) and use these techniques to extract some relevant facts about growth in countries across the world and over time.
...
Having seen how to calculate the growth rate of GDP from one year to the next in the previous section, we turn our attention in this section to the estimation of the trend growth rate of GDP over one or several decades, ie the growth rate around which annual growth rates tend to fluctuate. A trend growth rate provides a clearer summary of long-run trends than the annual growth rates presented in Table \@ref(tab:DiscreteTab), as it abstracts from short-run annual fluctuations. 

How can we calculate the annual trend growth rate? Figure \@ref(fig:mpdplot3) represents actual GDP per capita in the United States between 1870 and 2018 (black solid line) and an estimate of the trend in GDP per capita over the same period (dashed red line). We want to obtain an estimate of the annual growth rate of GDP per capita along this trend growth path. There are several valid methods to do so but there is at least one very incorrect one. 
...
GDP per capita in the United States increased from \$4,803 in 1870 to \$55,335 in 2018. You might be tempted to calculate the trend annual growth rate over these 148 years as the percentage change in GDP between these two dates divided by 148 as follows:
$$\bar{g} = \left(\frac{55,335}{4,803}-1 \right)\frac{1}{148}\times 100 = 7.11\%$$
However, that would be wrong. Starting at \$4,803 and assuming GDP per capita grows at an annual growth rate of 7.11% would lead to a level of GDP per capita 148 years later equal to \$124,840,484, more than 2000 times the actual value of GDP per capita in 2018! This cannot be a good estimate of the trend growth rate. 

The annual growth rate applies to the level of GDP prevailing in the previous year, which grows over time. This formula neglects the fact that the growth rate applies to larger and larger levels of GDP in this example, leading it to overestimate the annual growth rate.

### Example and intuition

The *compound annual growth rate* provides an estimate of the trend growth rate which avoids falling into the same trap while also only requiring as little information to be calculated. Intuitively, it is the growth rate such that if GDP per capita had grown at this same rate every year, then starting at \$4,803 in 1870, GDP per capita 148 years later would be exactly equal to \$55,335. 

Here is how the compound annual growth rate can be derived in the context of our example: 

- Assume that GDP per capita grows at the same rate $\bar{g}$ every year. 
- Using the growth rate formula, $\bar{g} = \frac{GDP_{1871}}{GDP_{1870}}-1$, the value of GDP per capita in 1871 can be written as:
$$GDP_{1871}=(1+\bar{g})GDP_{1870}$$
- Similarly, the value of GDP per capita in 1872 is given by:
...
This result illustrates the **compounding effect** at work in such a growth process where the level of GDP per capita to which the growth rate is applied is updated each year to take into account what happened in the previous year. This effect explains how an economy that is growing at a relatively small annual rate of 1.67\% may nevertheless experience the exponential increase observed in Figures \@ref(fig:mpdplot1) and \@ref(fig:mpdplot3). The reason why the incorrect method discussed above led to an incorrect estimate of the trend growth rate is because it ignored the presence of these compounding effects.

### The compound growth rate formula

More generally, compound growth rates may apply to any trending variable $y$ (GDP, population, ...) following an exponential pattern over time. Assuming its initial value at time $0$ is $y_0$ and it grows at the trend growth rate $\bar{g}$ per period over this interval of time. After $t$ periods its value is equal to:
$$ y_t = (1+\bar{g})^{t} y_0 $$ 
...
*Note*: if the variable grows at a constant rate, the slope of the plot of of the logarithm base 2 is constant, but it is not equal to the growth.
...
Using $y_t = (1+g)^{t} y_0$:
$$y_t = 2 \times y_0 = (1+g)^ty_0 \quad \rightarrow  2 = (1+g)^t  $$
...
## Two hundered years of growth in the United Kingdom and the United States
...
Can we observe the Hockey stick pattern in all countries? In which countries do we fail to observe it?
...
- When a series follows an exponential growth pattern, the compound growth rate provides a useful measure of the trend growth. It is calculated as:
$$ \bar{g} = \left(\frac{y_t}{y_0}\right)^{\frac{1}{t}} - 1 $$
where $\bar{g}$ is the trend growth rate and $y_0$ is the initial value of $y$.
- The slope of the plot of the logarithm of a variable over time provides a good approximation of the growth rate of this series at any point in time, provided the growth rate is small enough.
- Logarithmic scale: A log plot represents how many times a variable is multiplied by a given factor over a certain interval of time. It is particularly well suited to analyse growth trends.
- The rule of 70
- Compounding effect of growth: small differences in annual growth rates between countries may lead to large differences in the level of macroeconomic variables in the long-run.
...
- **Growth rates**
- **Compounding effects of growth rate**
- **Exponential growth**
- **Logarithm**: natural logarithm, logarithm base 2, logarithm base 10, ...
