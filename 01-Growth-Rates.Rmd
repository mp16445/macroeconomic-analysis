...
- **Compounding effect of growth**: growth in each period derives from growth achieved in the period. This explains why relatively small differences in annual growth rates between countries may lead to large differences in the level of macroeconomic variables in the long-run.
...
Assume GDP per capita in Atlantis grows by 10% every year and that it starts at an initial level of \$1000. By which percentage will GDP per capita have increased after 10 years?
...
Assume population grows at the rate of 5% every year in Gilead and that it starts with a total population of 100,000. By how many people total population will increase at the end of the first, second and third year respectively?
...
<br>
Based on the information in the plot above (*Source*: Maddison Project Database 2023) the annual trend growth rate in GDP per capita in Indonesia between 1950 and 2018 was:
...
<br>
The figure above represents the logarithm of GDP per capita in Indonesia (*Source*: Maddison Project Database 2023). Discuss the advantages and disadvantages associated with each of these subsamplings i) if the goal is to analyse long-run growth trends in GDP growth in Indonesia and ii) if you goal is to systematically compare GDP growth in different countries over time:
...
*The rule of 70 gives the number of years it would take for a variable to double given their annual growth rate. But we could derive similar formulas to calculate the number of years it would take for a variable to triple, quadruple, ..., given their trend annual growth rate.*
...
a. In the introduction we saw that GDP per capita in the UK and Nigeria have been multiplied by about 6 between 1885 and 2022. Using the expression derived in a., find an estimate of the trend annual growth rate in the two countries over this period. 
...
## Taking stock using Large Language Models (LLMs) {-}

*We recommend using Microsoft Copilot for Edge browser, which is free of charge to all students through the University Microsoft license, to do these exercises.*

Submit the following prompts to Microsoft Copilot before the class in week 14 and make notes of the answers to the bullet points. These answers will be discussed in class.
...
- Check that the numerical illustrations and the reasoning are correct.
- What insight did you learn from this answer if any?
- Can you ask a follow-up question (eg request more detail, add policy implications, ...)
