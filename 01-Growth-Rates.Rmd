...
The processes underlying long-run growth trends are not produced by deterministic forces largely beyond the control of human organisations. Rather, the trends we observe reflect the outcomes of historical processes in different societies at different points in time. They are made possible by specific institutional, geographical, cultural characteristics and shaped by relationships of power within and between countries. This chapter seeks to present conceptual tools to describe these trends. Economic models, such as the one described in chapter 3, seek to explain the regularities rendered possible by this wider environment and put in motion by policies.


### Growth rates and the dynamic performance of economies {-}

The dynamics of GDP over the long term observed in Figure \@ref(fig:mpdplot1) are the result of growth processes that are cumulative over time. Each year, an economy has the potential to capitalise on the previous level of ouptut to generate more output, which allows for further increases in output in the following year, etc... The *growth rate* of output from one year to the next is an indicator of this dynamic performance of an economy. Irrespective of the size of the economy, it can also be used to compare the economic performance of different countries over the same period or the performance of a single economy over different periods. Economic theories of growth seek to understand the mechanisms that drive these changes in output and growth over time and the reasons why they may differ across countries. 
