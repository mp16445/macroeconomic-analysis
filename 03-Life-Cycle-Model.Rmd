...
Why is the capital-labour ratio converging to a constant value? Because the capital stock depends on the wage, and as the capital stock increases, the wage increases by less and less each time (due to diminishing returns to capital), leading to smaller increases in savings, assets and the capital stock.  
...
The notions of **equilibrium** and **steady state** are important concepts discussed in this chapter. This exercise helps you explore these two concepts further using Copilot. 
