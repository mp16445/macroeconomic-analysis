...
- Explain the relationship between *growth rates* and *levels* of GDP.
...
- Describe and investigate long-run growth trends in GDP, population, capital, consumption, ... over time and across countries.
...
This figure allows us to make some comparison between **levels** of GDP per capita over time and across countries. However, the evolution of these levels and of these gaps between countries over the long term are the results of growth processes that are cumulative over time. We usually express **growth rates** (as well as interest rates) in annual terms. What is the relationship between *levels* and *annual growth rates* of GDP and how can they help us understand long-run trends? Two comparisons shed some light on the relationship between the two concepts.

Between 1885 and 2022, GDP per capita in the UK increased from \$6,132 to \$38,407 (both expressed in 2011 prices). Standards of living have been multiplied by more than 6 in the UK over this period. In contrast, US GDP per capita over the same period has increased from \$6,424 to \$58,487 (in 2011 prices) so that standards of living have been multiplied by 9. Starting at a similar level as the UK, US GDP per capita has therefore grown at a faster rate and is now about 50% higher. Americans on average have now bigger salaries, bigger fridges, bigger cars than the average Briton. How much higher must have been the annual growth rate of GDP per capita in the US relative to the UK's to arrive at this outcome?

Let us now compare the UK experience with that of Nigeria, where GDP per capita between 1885 and 2022 has increased from \$810 to \$5,070 (in 2011 prices). In both countries, standards of living have been multiplied by slightly more than 6 over this period. As we will see, this means that they have grown at the same average annual growth rate over this period. As a result, the two countries have not diverged further over this period but they have not converged either; the UK was slightly more than 7.5 times richer than Nigeria in 1885 and it is still a bit more than 7.5 times richer than Nigeria in 2022. In other words, both at the beginning and at the end of the period, the average British household could afford seven times as many goods as Nigeria. If two countries grow at the same annual growth rate, their GDP per capita will not converge if they start at different levels. If GDP per capita in Nigeria were to catch up to that in the UK, how much higher should be its annual growth rate?

The answer to both questions is probably less than you would expect due to the power of compounding effects. In this chapter, we will see how we can take into account these insights to calculate trend growth rates (using compound growth rates) and represent these growth experiences graphically (using logarithm plots). We will then use these techniques to extract some relevant facts about growth in countries across the world.
...
Assume we observe a trending variable $y$ (GDP, population, ...) following an exponential pattern between time $0$ and time $t$. Its initial value is $y_0$ and it grows at the trend growth rate $\bar{g}$ per period over this interval of time. After $t$ periods its value is equal to:
$$ y_t = (1+\bar{g})^{t} y_0 $$ 
...
the value of $y_1$ can be rewritten as a function of $y_0$ and the growth rate $\bar{g}$ as follows:
$$\frac{y_1}{y_0} = 1 + \bar{g}$$
$$y_1 = (1 + \bar{g})y_0$$
Similarly, at time $2$: 
$$y_2 = (1+\bar{g})y_1$$
...
To see the intuition behind this result, let's do the following exercise. Assume that GDP per capita grows at the same rate $\bar{g}$ every year. Then the value of GDP per capita in 1871 can be written as:
...
### When should we use the compound annual growth rate to estimate the trend growth rate?
...
- The slope of the plot of the logarithm of a series over time provides a good approximation of the growth rate of this series at any point in time, provided the growth rate is small enough.
- A log plot represents how many times a variable is multiplied by a given factor over a certain interval of time. It is particularly well suited to analyse growth trends.
- Small differences in annual growth rates between countries may lead to large differences in the level of macroeconomic variables in the long-run.
...
- **Growth rates**: per period growth rate, trend growth rate, compound growth rate.
- **Exponential growth**
...
*In this chapter, we have discussed the implications of the compounding effects of growth rates on inequality in GDP per capita across countries in the long-run. Another area of economics where compounding effects play an important role is when interest rates differ across assets.*
